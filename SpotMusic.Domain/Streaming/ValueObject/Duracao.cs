namespace SpotMusic.Domain.Streaming.ValueObject
{
    public record Duracao
    {
        ...
        public Duracao(int valor)
        {
            if(valor < 0)
            {
                throw new Exception("Duracao da musica não pode ser negativa");
            }
        ...
        //public static bool operator ==(Duracao x, Duracao y) => y.Valor == x.Valor;
        //public static bool operator !=(Duracao x, Duracao y) => y.Valor == x.Valor;
        //public static bool operator ==(Duracao x, int y) => y == x.Valor;
        //public static bool operator !=(Duracao x, int y) => y == x.Valor;
    }
}
